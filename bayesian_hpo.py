...
def find_best_hyperparams(X_train,y_train,param_grid,categorical_feats,model,metric_fnc): # Bayesian way
    ...
    def compute_cv_score(temp_hyp_cfg):
        ...
        for train_index, test_index in kf.split(X_train):   
            ...
            #model = LogisticRegression(solver = 'saga', penalty='elasticnet',**temp_hyp_cfg)
